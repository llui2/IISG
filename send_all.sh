...
# Temp="0.40 1.00 1.20 1.40 1.60 1.80 2.00 2.20 2.40 2.60 2.80 3.00 3.20 3.40 3.60 3.80 4.00 4.20 4.40 4.60 4.80 5.00 6.00 7.00 8.00 9.00"
# Temp=" "
...
do
    ...
    sed -i "4s/.*/#$ -N N300-H$H-T$j/" $jobfile
