...
Temp =  ["1.20", "1.40", "1.60", "1.80", "2.00", "2.20", "2.40", "2.60", "2.80", "3.00", "3.20", "3.40", "3.60", "3.80", "4.00", "4.20", "4.40", "4.60", "4.80", "5.00"]

data = []
for i in range(len(Temp)):
    file = open(f"results-H001/results-H0.01-T{Temp[i]}/data/gamma.dat", "r")
...
data = []
for i in range(len(Temp)):
    file = open(f"results-H001/results-H0.01-T{Temp[i]}/data/mz.dat", "r")
    lines = file.readlines()
    lines = lines[1:]
    file.close()
    for line in lines:
